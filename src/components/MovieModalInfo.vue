        ...
        <div class="movie-info-content">
            <BRow>
                ...
                <BCol sm="8">
                    ...
                    <BFormRating class="movie-rating" v-model="movie.imdbRating" readonly show-value precision="1" stars="10" show-value-max no-border />
                    <p class="movie-descr"> {{movie.Plot}}</p>
                    <div class="mt-3 mb-4">
